...
-module(istanbus_web_stop_search_location_resource).
...
to_json(ReqData, Context) ->
    ...
    Locations = istanbus_core_stop_module:search_and_get_location(Keywords),
    {mochijson2:encode(Locations),  ReqData, Context}.
